...
from batch_renormalization import BatchRenorm1d
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.br0 = BatchRenorm1d(320, r_d_func)
        self.fc1 = nn.Linear(320, 50)
        self.br1 = BatchRenorm1d(50, r_d_func)
        self.fc2 = nn.Linear(50, 10)

    def forward(self, x, itr):
        x = F.relu(self.br0(self.fc0(x), itr))
        x = F.relu(self.br1(self.fc1(x), itr))
        x = F.relu(self.fc2(x))
